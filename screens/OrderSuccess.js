    ...
    return (
        <View>
            ...
            <View style={{ marginHorizontal: 20 }}>
                ...
                <Text style={{ color: 'gray', fontSize: 18, fontWeight: 'normal', marginTop: 10 }}>Long@gmail.com</Text>
                <Text style={{ color: 'gray', fontSize: 18, fontWeight: 'normal', marginTop: 10 }}>60 Lê Đại Hành,Kim Tân Lào Cai</Text>
                <Text style={{ color: 'gray', fontSize: 18, fontWeight: 'normal', marginTop: 10 }}>01222222</Text>
