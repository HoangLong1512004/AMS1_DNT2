    ...
    <View>
      ...
      <View style={{ marginHorizontal: 20 }}>
        ...
        <ScrollView>
          ...
          <Text style={{ color: 'gray', fontSize: 18, fontWeight: 'normal', marginTop: 15 }}>Nguyễn Hoàng Long</Text>
          <Text style={{ color: 'gray', fontSize: 18, fontWeight: 'normal', marginTop: 10 }}>longnhph42829@fpt.edu.vn</Text>



          <Text style={{ color: 'gray', fontSize: 18, fontWeight: 'normal', marginTop: 10 }}>60 Lê Đại Hành, Kim Tân Lào Cai</Text>
          <Text style={{ color: 'gray', fontSize: 18, fontWeight: 'normal', marginTop: 10 }}>012213</Text>
          ...
          <Text style={{ color: 'gray', fontSize: 18, fontWeight: 'normal', marginTop: 15 }}>Giao hàng nhanh - 29.000đ</Text>
          <Text style={{ color: 'gray', fontSize: 18, fontWeight: 'normal', }}>(Dự kiến giao hàng 19/6)</Text>
