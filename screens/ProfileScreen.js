    ...
    return (
        <View>
            ...
            <View style={{ flexDirection: 'row', margin: 20 }}>
                ...
                />
                <View>
                    <Text style={{ color: 'black', fontWeight: 'bold', fontSize: 17, marginLeft: 10 }}>Nguyễn Hoàng long</Text>
                    <Text style={{ color: 'gray', fontSize: 15, marginLeft: 10, marginTop: 10 }}>longnhph42829@fpt.edu.vn</Text>
                </View>
            </View>
